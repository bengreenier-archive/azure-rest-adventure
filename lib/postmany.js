...
exports.problem = 'Add an express route for POST requests to /items and process the incoming message body.\n'
    + 'Expect the request to match POST /items with body that matches [{name: "", value: ""}...]\n'
    + 'Use `$ADVENTURE_COMMAND verify <path/to/entry/point.js>` to validate.'
    + '\n'
    + 'Hint: extend some existing logic to support this new behavior\n'
