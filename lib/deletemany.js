...
exports.problem = 'Add an express route for DELETE requests to /items and remove all items.\n'
    + 'Expect the request DELETE /items and respond with a 200 status code and an empty body.\n'
